...
(* OASIS_START *)
(* DO NOT EDIT (digest: 11cc516a23a8e5372f22839eb3782932) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_path = "tests/";
                      bs_compiled_object = Native;
                      bs_build_depends = [InternalLibrary "pttcp"];
               ...
               Executable
                 ({
                   ...
                   {exec_custom = true; exec_main_is = "server.ml"; })
            ];
     ...
     oasis_version = "0.3.1";
     oasis_digest =
       Some "\242\134\178\191(\250\025J\143\023\170\233\011_\245u";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
